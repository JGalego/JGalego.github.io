...
<img src="assets/images/escher.png" width="100%" alt="Panel from Metamorphosis II (1939-1940) by M. C. Escher"/>
</div>

### Old Stuff in the Attic 📦

* [A Tour of GenAI](https://jgalego.github.io/GenAI) — where GenAI came from and where it's headed
* [Mapping Embeddings](https://jgalego.github.io/MappingEmbeddings) — from meaning to vectors and back
...
* [Hacker News Digest](https://hndigest.com/) delivers the top HN stories straight to your inbox every morning — read it after breakfast and skip the comments rabbit hole
...
<img src="/assets/images/south_park_4point_plan.gif" width="25%" alt="Cartman's 4-point business plan from South Park"/>
</div>

### Some (Supposedly) Fun Things 🎡
...
* Dan McKinley's [Choose Boring Technology](https://boringtechnology.club/) — or *"how to be old, for young people"*
...
* Aditya Bhargava's [X in Pictures](https://www.adit.io/posts/2013-04-17-functors,_applicatives,_and_monads_in_pictures.html) series makes functional programming's scariest words finally click
...
* Everything by [3Blue1Brown](https://www.youtube.com/@3blue1brown) is visual mathematics and education at its finest... [here's how](https://www.youtube.com/watch?v=rbu7Zu5X1zI) he creates those mesmerizing animations with [Manim](https://github.com/3b1b/manim)
...
* John Herrick's [deep dive into elevator scheduling](https://john.fun/elevators) reveals the surprisingly rich optimization problem hiding behind every elevator ride 🛗
* Sean Goedecke's [Great software design looks underwhelming](https://www.seangoedecke.com/great-software-design/) shows how the best designs eliminate failure modes instead of defending against them
* [Cognitive Load Is What Matters](https://github.com/zakirullin/cognitive-load) argues the whole point of good software design is keeping how much you have to think about to a minimum
* [Making Deep Learning Go Brrrr From First Principles](https://horace.io/brrr_intro.html) and its spiritual sequel [GPUs Go Brrr](https://hazyresearch.stanford.edu/blog/2024-05-12-tk) explain exactly why your GPU is bored
* [awesome-falsehood](https://github.com/kdeldycke/awesome-falsehood) catalogs everything programmers confidently get wrong about names, dates, addresses, and more
...
* Google [search for "recursion"](https://www.google.com/search?q=recursion) and it asks "Did you mean: *recursion*" 🔁

<div align="center">
<!-- Google recursion easter egg -->
<img src="/assets/images/google_recursion.png" width="75%" alt="Google search results for 'recursion' showing 'Did you mean: recursion'"/>
</div>

* xkcd's [Self-Description](https://xkcd.com/688/) is a comic whose entire content is a legend describing the comic itself
