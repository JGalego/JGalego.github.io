...
* Peter Thiel's [Zero to One: Notes on Startups, or How to Build the Future](https://www.amazon.com/Zero-One-Notes-Startups-Future/dp/0804139296) is a must read - you may not agree with everything he writes (I don't), but you won't stay indifferent
* [Startup Stash](https://startupstash.com/) has a sizeable collection of tools for startups and entrepreneurs
* Perhaps not surprisingly, most AWS-flavored delectables for startups can be found in [AWS Startups](https://aws.amazon.com/startups)
...
* [IP over Avian Carriers](https://datatracker.ietf.org/doc/html/rfc1149) - an IETF RFC for... well, the name says it all 🐦; contains memorable sentences like *"because IP only guarantees best effort delivery, loss of a carrier can be tolerated"*
