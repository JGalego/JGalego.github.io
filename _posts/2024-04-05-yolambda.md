...
and it was designed to be smaller 🤏 and faster ⚡ than previous iterations.
...
>❗ This introduction was written before the release of [YOLOv9](https://docs.ultralytics.com/models/yolov9/).
...
> 🧪 **Experimental:** Switch to the [`feat/YOLOv9`](https://github.com/JGalego/YOLambda/tree/feat/YOLOv9) branch if you dare!
...
> 💡 The YOLOv8 series offers a wide range of models both in terms of size (`n`ano >> `x`l) and specialized task like `seg`mentation or `pose` estimation. If you want to try a different model, please refer to the official documentation ([Supported Tasks and Modes](https://docs.ultralytics.com/models/yolov8/#supported-tasks-and-modes)).

> 🧪 **Experimental:** Replace `yolov8n` with `yolov9c` in the commands below to work with YOLOv9. Just keep in mind that the performance and the output of our app may not be the same.
...
Whenever you're ready, just start the deployment 🚀
...
The deployment should be done by the time if you finish reading the text above 😊 Don't forget to note down the function URL.
...
<div align="center">
<img width="75%" src="/assets/images/yolambda_pipeline.jpg"/>
</div>
...
- [Ultralytics YOLOv8 Docs](https://docs.ultralytics.com/)
  ...
  - [YOLOv5 🚀 on AWS Deep Learning Instance: Your Complete Guide](https://docs.ultralytics.com/yolov5/environments/aws_quickstart_tutorial/)
...
- [HowTo: deploying YOLOv8 on AWS Lambda  (an alternative implementation 💪](https://www.trainyolo.com/blog/deploy-yolov8-on-aws-lambda)