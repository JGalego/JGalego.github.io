...
In this episode of #TGIFun🎈, discover how to deploy **any YOLO version** 👁️ (YOLOv5-11, and beyond) on [AWS Lambda](https://aws.amazon.com/lambda/) using the [AWS SAM](https://aws.amazon.com/serverless/sam/) CLI.

<!-- excerpt-end -->

Deploying YOLO on Lambda delivers an optimal balance of performance, scalability, and cost efficiency. The latest YOLambda version supports **version-agnostic** deployment — use any YOLO model from YOLOv5 to YOLOv11 and future releases without changing a single line of deployment code.

**✨ Key Features:**

- 🔄 **Version-Agnostic**: Compatible with YOLOv5, YOLOv8/9/10/11, and future versions
- 🚀 **Serverless**: Automatic scaling with AWS Lambda  
- 🔧 **Configurable**: Swap models effortlessly via environment variables
- 📦 **ONNX Optimized**: Lightning-fast inference with ONNX Runtime

👨‍💻 All code and documentation is available at [github.com/JGalego/YOLambda](https://github.com/JGalego/YOLambda).

### YOLO in Pictures 🖼️

What exactly is YOLO and why should you care? Let's start with a brief overview.
...
and each new model is designed to be smaller 🤏 and faster ⚡ than previous iterations.
...
In this project, we're going to create a simple object detection app that accepts an image 🖼️
...
- 🐍 [Conda](https://conda.io/projects/conda/en/latest/user-guide/install/index.html) (preferred) or vanilla [Python](https://www.python.org/) (version `>=3.9`)
- 🐳 [Docker](https://docs.docker.com/engine/install/)
- 🐿️ [AWS SAM](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/install-sam-cli.html)
...
<div align="center">
<img width="30%" src="/assets/images/onnx_simplify.png" alt="Terminal output simplifying and optimizing an ONNX model"/>
</div>
...
<div align="center">
<img width="75%" src="/assets/images/yolo_computational_graph_detail.png" alt="YOLO model computational graph viewed in Netron"/>
</div>
...
<div align="center">
<img width="75%" src="/assets/images/yolambda_pipeline.png" alt="Diagram of the YOLambda serverless inference pipeline on AWS Lambda"/>
</div>
...
- **Technical Resources:**
  ...
  - [HowTo: deploying YOLOv8 on AWS Lambda](https://www.trainyolo.com/blog/deploy-yolov8-on-aws-lambda) (an alternative implementation 💪)